                        ...
                        <form onSubmit={handleSignIn} className="space-y-7">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    required
                                    className="mt-1 block w-full px-5 py-3.5 border border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#094517]/20 focus:border-[#094517] sm:text-sm bg-white backdrop-blur-sm text-gray-900 placeholder-gray-400 transition duration-150"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label
